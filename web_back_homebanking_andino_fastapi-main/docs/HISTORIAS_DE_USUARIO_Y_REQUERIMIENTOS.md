...
- Login: `username` = `codcliente` en minúscula, `dni` = documento del cliente y clave de internet asignada.
- Las credenciales de prueba deben administrarse por canal interno y no publicarse en documentación.
